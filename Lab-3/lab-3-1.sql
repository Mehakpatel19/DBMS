...
select ssn,fname,lname from employee order by ssn;

insert into project values
('ProductXYZ','12','Banglore','5');
...
select fname,lname,salary from employee where salary >45000;
select fname,lname,salary from employee where salary between 45000 and 60000;
select fname,lname,dno from employee where dno=5;
select fname,lname,dno from employee where sex='M';
...
select * from employee 
where dno=(select dnumber from department where dname='IT');
